...
build-lambdas:
	mkdir -p cdk/dist/get-products-list cdk/dist/get-product-by-id cdk/dist/create-product
	...
	GOOS=linux GOARCH=amd64 CGO_ENABLED=0 go build -buildvcs=false -tags lambda_create_product -o cdk/dist/create-product/bootstrap ./cdk/lambda/create-product
